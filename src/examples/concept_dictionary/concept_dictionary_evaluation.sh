...
test_features_path=/home/ytllam/xai/xl-vlms/out/features/save_hidden_states_for_token_of_interest_llava_dog_generation_split_test.pth
...
decomposition_path=results/decompose_activations_text_grounding_image_grounding_results_dog_train.pth  # Filepath of saved results
